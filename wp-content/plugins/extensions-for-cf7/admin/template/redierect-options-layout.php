		...
		<tbody>
			...
			<tr class="extcf7-js-code">
				...
				<td class="extcf7-checkbox">
					...
					<p style="color: #a94442; background: #f2dede;padding: 15px;"><strong><?php echo esc_html__('Warnings! ')?></strong><?php echo esc_html__("This options for developer only.If the javascript action doesn't work after form submission, it means You have a problem with your code.",'cf7-extensions');?></p>
				</td>
			</tr>
		</tbody>
	</table>
